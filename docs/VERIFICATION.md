...
`xchecker` has three verification surfaces:
...
Pull requests run advisory `ripr` evidence and review guidance. Future routing can use impacted evidence, labels, release-risk, or severe `ripr` gaps to trigger targeted mutation.
