//! Workspace/project CLI command handlers.
//!
//! Keeps workspace orchestration, status aggregation, history rendering, and TUI
//! launching separate from argument parsing in `cli.rs`.
