//! Project/workspace CLI subcommands and handlers.
//!
//! This module owns workspace-oriented command parsing and execution so the
//! top-level CLI module can focus on global argument dispatch.
...
pub(super) fn execute_project_status_command(
