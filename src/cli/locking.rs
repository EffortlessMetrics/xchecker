...
pub(crate) fn detect_claude_cli_version() -> Result<String> {
...
pub(crate) fn build_flow_context(config: &Config) -> crate::lock::FlowContext {
...
pub(crate) fn check_lockfile_drift(
    spec_id: &str,
    strict_lock: bool,
    model_full_name: &str,
